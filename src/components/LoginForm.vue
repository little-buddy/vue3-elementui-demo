...
<template>
  <el-form ref="formRef" :model="loginInfo" :rules="rules" class="space-y-6">
    <el-form-item prop="username">
      <el-input v-model="loginInfo.username" class="h-[40px]" :prefix-icon="User" placeholder="用户名" clearable />
    </el-form-item>
    <el-form-item prop="password">
      <el-input v-model="loginInfo.password" class="h-[40px]" :prefix-icon="Lock" placeholder="请输入密码" type="password" clearable show-password />
    </el-form-item>
